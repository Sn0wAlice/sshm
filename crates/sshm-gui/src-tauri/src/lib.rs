...
pub fn make_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::ping_hosts,
            commands::host_key_info,
            commands::pin_host_key,
            ...
            commands::kluster_add_cluster,
            commands::kluster_update_cluster,
            commands::kluster_delete_cluster,
            commands::kluster_add_docker_remote,
            commands::kluster_delete_docker_remote,
            commands::kluster_kube_contexts,
